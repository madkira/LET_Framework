...
#define ASSERT_DOUBLE6(a, b, ...) ASSERT_int(a, b, __VA_ARGS__, #b) // <== New function added
...
#define ASSERT_DOUBLE(...) ASSERT_DOUBLE_FUNC(__VA_ARGS__, ASSERT_int, ASSERT_DOUBLE6, ASSERT_DOUBLE5, ASSERT_DOUBLE4, ASSERT_DOUBLE3, ASSERT_DOUBLE2)(__VA_ARGS__)
